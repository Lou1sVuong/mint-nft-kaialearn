...
contract KaiaLearnNFT is ERC721 {
    ...
    function mintCertificate(
        ...
        require(!hasCompletedAssignment[msg.sender][title], "You have already completed this assignment");
        
        // Kiểm tra xem bài tập đã tồn tại chưa
        require(!assignmentExists[title], "This assignment already exists");
